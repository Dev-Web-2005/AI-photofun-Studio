...
public class RegisterUserRequest {
  ...
  @NotBlank(message = "CONFIRM_PASSWORD_REQUIRED") String confirmPass;
  ...
  @Builder.Default Set<String> roles = new HashSet<>(List.of("USER"));

  @Builder.Default boolean loginByGoogle = false;

  @Builder.Default boolean loginByFacebook = false;
}
