...
const SUGGESTION_PROMPTS = [
  { id: 1, text: "How to create an image?", icon: "🎨" },
  { id: 2, text: "How to create a video?", icon: "🎬" },
  { id: 3, text: "How to remove background?", icon: "✂️" },
  { id: 4, text: "How to upscale image?", icon: "🔍" },
  { id: 5, text: "How to use style transfer?", icon: "🎭" },
];
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {messages.length === 1 && (
              <div className="flex flex-wrap gap-2 mt-3 p-3 rounded-xl bg-gradient-to-r from-transparent via-slate-100/5 to-transparent animate-fade-in">
