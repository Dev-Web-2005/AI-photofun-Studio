...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={`fixed left-0 top-0 h-screen w-20 flex flex-col items-center py-6 border-r border-gray-200 bg-white z-50 transition-transform duration-300 ease-in-out ${
