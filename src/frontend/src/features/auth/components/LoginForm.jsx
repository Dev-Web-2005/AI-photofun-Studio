        ...
        <div className="bg-white rounded-2xl p-10 shadow-2xl animate-fade-in-down">
          ...
          <div className="flex gap-3 mb-6">
            ...
            <button
              ...
              className="flex-1 py-3 bg-white border-2 border-gray-200 rounded-xl cursor-pointer transition-all duration-300 flex items-center justify-center gap-2 font-semibold text-sm hover:border-[#1877F2] hover:bg-blue-50 hover:-translate-y-0.5"
            >
