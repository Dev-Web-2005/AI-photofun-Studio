...
const IMAGE_TO_VIDEO_MODELS = [
  ...
  {
    value: "wan2.1-i2v-turbo",
    label: "wan2.1-i2v-turbo",
    description: "Turbo - fastest",
  },
  {
    value: "wan2.1-i2v-plus",
    label: "wan2.1-i2v-plus",
    description: "Old Plus version",
  },
];
...
const ImageToVideo = () => {
  ...
  const handleGenerate = async () => {
    ...
    if (result.success && result.taskId) {
      ...
      toast.error(
        result.error || "Unable to generate video. Please try again."
      );
      setLoading(false);
    }
  };
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
            ...
            >
              {uploading ? (
                <div className="py-4">
                  <div className="w-8 h-8 border-2 border-gray-300 dark:border-gray-600 border-t-purple-500 dark:border-t-white rounded-full animate-spin mx-auto mb-2" />
              ...
              <div className="aspect-video border-2 border-dashed border-gray-200 rounded-2xl flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-sm text-gray-500">
                    Upload an image, enter motion description and click
                    "Generate Video"
                  </p>
                </div>
              </div>
