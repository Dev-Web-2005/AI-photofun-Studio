...
const Relight = () => {
  ...
  const [prompt, setPrompt] = useState(
    "Warm sunset lighting, golden hour glow"
  );
  ...
  const handleRelight = async () => {
    if (!canRelight) {
      toast.warning(
        "Please upload an image and enter a lighting description first."
      );
      return;
    }
            ...
            {processing ? (
              <div className="aspect-square bg-gray-50 dark:bg-gray-900 rounded-2xl flex items-center justify-center">
                <div className="text-center">
                  <div className="w-16 h-16 border-4 border-gray-200 dark:border-gray-600 border-t-orange-500 dark:border-t-white rounded-full animate-spin mx-auto mb-4" />
